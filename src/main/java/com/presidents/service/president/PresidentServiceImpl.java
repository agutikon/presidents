...
public class PresidentServiceImpl implements PresidentService {
    ...
    @Override
    public Set<PresidentDto> findPresidentsByParty(String party) {
        return presidentsRepository.findPresidentsByParty(party).stream()
    ...
    public PresidentDto updatePresident(PresidentDto presidentDto) {
        ...
        if (president.isPresent()) {
            president.map(p -> {
                ...
                p.setParty(presidentDto.getParty());
